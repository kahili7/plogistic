...
<div class="column span-8 last">
	<?=form_dropdown('_modules_rid', get_modules_list(), set_value('_modules_rid', $ds->_modules_rid), 'id="_modules_rid" class="text" style="width:200px;" readonly="readonly" ')?>
</div>
...
<div class="column span-8">
	<?=form_input('item_name', set_value('item_name', $ds->item_name), 'id="item_name" class="text" style="width:150px;" readonly="readonly" ')?>
</div>
...
<div class="column span-20 last">
	<?=form_input('item_order', set_value('item_order', $ds->item_order), 'id="item_order" class="text" style="width: 40px;" readonly="readonly" ')?>
</div>
