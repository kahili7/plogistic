...
class CACHE_MEMCACHED extends KI_DRIVER 
{
	...
	private function _setup_memcached()
	{
		...
		if ($KI->config->load('memcached', TRUE, TRUE))
		{
			if (is_array($KI->config->config['memcached']))
			{
				$this->_memcache_conf = NULL;

				foreach ($KI->config->config['memcached'] as $name => $conf)
				{
