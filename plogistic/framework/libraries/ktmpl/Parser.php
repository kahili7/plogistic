<?
class Ktmpl_Parser implements Ktmpl_ParserInterface
{
    protected $stream;
    protected $parent;
    protected $handlers;
    ...
    public function parse(Twig_TokenStream $stream)
    {
		...
		{
            $this->expressionParser = new Ktmpl_ExpressionParser($this, $this->env->getUnaryOperators(), $this->env->getBinaryOperators());
        }
